...
// import { decodeBase16 } from '../../src/lib/Conversions';
...
//     expect(
//       CLU32.fromBytes(bytesU32)
//         .unwrap()
//         .toBytes()
//         .unwrap()
//     ).to.deep.eq(
//       CLValue.u32(0xf0e0_d0c0)
//         .toBytes()
//         .unwrap()
//     );
...
//     );
//     expect(
//       CLI64.fromBytes(bytesI64)
//         .unwrap()
//         .toBytes()
//         .unwrap()
//     ).to.deep.eq(
//       CLValue.i64('198572906121139257')
//         .toBytes()
//         .unwrap()
//     );
...
//     );
//     expect(
//       CLU64.fromBytes(bytesU64)
//         .unwrap()
//         .toBytes()
//         .unwrap()
//     ).to.deep.equal(
//       CLValue.u64('14198572906121139257')
//         .toBytes()
//         .unwrap()
//     );
...
//         .unwrap()
//     ).to.deep.equal(
//       CLValue.u64('9834009477689550808')
//         .toBytes()
//         .unwrap()
//     );
//   });
...
//         .unwrap()
//     ).to.deep.equal(
//       CLValue.u128(0x0000_f0e0_d0c0_0000)
//         .toBytes()
//         .unwrap()
//     );
//   });
...
//     );
//     expect(
//       CLString.fromBytes(bytesString)
//         .unwrap()
//         .toBytes()
//         .unwrap()
//     ).to.deep.equal(
//       CLValue.string('test_测试')
//         .toBytes()
//         .unwrap()
//     );
//   });
...
//     const bytes = toBytesVector([new CLString('get_payment_purse')]);
//     // console.log(bytes);
...
//   // expect(CLKey.fromBytes(bytes).unwrap()).to.deep.equal(
//   //   decodeBase16(urefAddr)
//   // );
//   // expect(CLKey.fromBytes(bytes).value()?.uRef?.accessRights).to.deep.equal(
