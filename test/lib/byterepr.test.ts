...
describe(`numbers' toBytes`, () => {
  it('should be able to serialize/deserialize u8', () => {
    ...
    expect(
      U8.fromBytes(bytesU8)
        .value()
        .toBytes()
    ).to.deep.eq(CLTypedAndToBytesHelper.u8(10).toBytes());
  ...
  it('should be able to serialize/deserialize u32', () => {
    ...
    expect(
      U32.fromBytes(bytesU32)
        .value()
        .toBytes()
    ).to.deep.eq(CLTypedAndToBytesHelper.u32(0xf0e0_d0c0).toBytes());
    ...
    expect(
      U32.fromBytes(bytesU32)
        .value()
        .toBytes()
    ).to.deep.eq(CLTypedAndToBytesHelper.u32(100000).toBytes());
    ...
    expect(
      U32.fromBytes(bytesU32)
        .value()
        .toBytes()
    ).to.deep.eq(CLTypedAndToBytesHelper.u32(0).toBytes());
  });
  ...
  it('should be able to serialize/deserialize i32', () => {
    ...
    expect(
      I32.fromBytes(bytesI32)
        .value()
        .toBytes()
    ).to.deep.eq(CLTypedAndToBytesHelper.i32(-100000).toBytes());
    ...
    expect(
      I32.fromBytes(bytesI32)
        .value()
        .toBytes()
    ).to.deep.eq(CLTypedAndToBytesHelper.i32(0).toBytes());
    ...
    expect(
      I32.fromBytes(bytesI32)
        .value()
        .toBytes()
    ).to.deep.eq(CLTypedAndToBytesHelper.i32(-1).toBytes());
  });
  ...
  it('should be able to serialize/deserialize i64', () => {
    ...
    expect(
      I64.fromBytes(bytesI64)
        .value()
        .toBytes()
    ).to.deep.equal(CLTypedAndToBytesHelper.i64('-4009477689550808').toBytes());
  });
  ...
  it('should be able to serialize/deserialize u128', () => {
    ...
    expect(
      U128.fromBytes(bytesU128)
        .value()
        .toBytes()
    ).to.deep.equal(CLTypedAndToBytesHelper.u128(100000).toBytes());
    ...
    expect(
      U128.fromBytes(bytesU128)
        .value()
        .toBytes()
    ).to.deep.equal(CLTypedAndToBytesHelper.u128(0xf0e0_d0c0_0000).toBytes());
  ...
  it('should be able to serialize/deserialize utf8 string', () => {
    ...
    expect(
      StringValue.fromBytes(bytesString)
        .value()
        .toBytes()
    ).to.deep.equal(CLTypedAndToBytesHelper.string('test_测试').toBytes());
  });
  ...
  it('should be able to serialize/deserialize unit', () => {
    ...
    expect(
      Unit.fromBytes(bytesUnit)
        .value()
        .toBytes()
    ).to.deep.equal(CLTypedAndToBytesHelper.unit().toBytes());
  });
  ...
  it('Serializes to proper byte array', () => {
    const myList = CLTypedAndToBytesHelper.list([
      CLTypedAndToBytesHelper.bool(false)
    ]);
