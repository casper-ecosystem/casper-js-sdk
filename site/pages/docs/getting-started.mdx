...
If you're running or connecting directly to your own node instead, the default RPC port is `7777` and the SSE (event stream) port is `9999`, e.g. `http://<Node Address>:7777/rpc`.
