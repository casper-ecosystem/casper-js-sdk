...
export class Contract {
   ...
   * @param contractPackageHash The hexadecimal smart contract package hash, with the prefix "hash-"
   */
   ...
   * @param chainName The name of the network the installment deploy will be sent to. Use "casper" for the Casper mainnet, "casper-test" for the Casper official testnet, and "casper-net-*" for local NCTL instances, where * is equal to the id of the node you wish to deploy to.
   ...
   * @param entryPoint The entrypoint of a smart contract that you wish to call
