...
interface CasperLabsHelper {
  ...
  /**
   * Sign over an arbitrary string message (with Casper header).
   *
   * @param messageWithHeaders string message with headers. Generated by `signedMessage.formatMessage()` method.
   * @param signingPublicKey public key in hex format, the corresponding secret key will be used to sign.
