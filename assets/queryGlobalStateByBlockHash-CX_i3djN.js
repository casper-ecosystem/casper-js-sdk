import{u as a,j as e}from"./index-BybjzhoQ.js";const n={title:"queryGlobalStateByBlockHash",description:"undefined"};function i(r){const s={a:"a",code:"code",div:"div",h1:"h1",h2:"h2",h3:"h3",header:"header",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",ul:"ul",...a(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.header,{children:e.jsxs(s.h1,{id:"queryglobalstatebyblockhash",children:["queryGlobalStateByBlockHash",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#queryglobalstatebyblockhash",children:e.jsx(s.div,{"data-autolink-icon":!0})})]})}),`
`,e.jsx(s.p,{children:"Queries a value from global state at a specific block, identified by hash."}),`
...
`,e.jsxs(s.h3,{id:"blockhash",children:["blockHash",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#blockhash",children:e.jsx(s.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(s.ul,{children:[`
`,e.jsxs(s.li,{children:[e.jsx(s.strong,{children:"Type:"})," ",e.jsx(s.code,{children:"string"})]}),`
`]}),`
`,e.jsx(s.p,{children:"Block hash as a hex string."}),`
...
`,e.jsx(s.li,{children:e.jsx(s.a,{href:"/actions/state/queryGlobalStateByBlockHeight",children:e.jsx(s.code,{children:"queryGlobalStateByBlockHeight"})})}),`
...
`]})]})}function d(r={}){const{wrapper:s}={...a(),...r.components};return s?e.jsx(s,{...r,children:e.jsx(i,{...r})}):i(r)}export{d as default,n as frontmatter};
